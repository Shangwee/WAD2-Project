...
<body>
    <div id="main">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Create a shopping list to ensure that you only buy the necessities when you go grocery shopping.</p>
                            <?php
                                if ($_SESSION["login"]) {
        ...
        <section id="contact-us" class="py-5 ">
            <div class="container">
                <h2>Contact Us <span class="material-icons">contact_support</span></h2>
