            ...
            <div class="container">
                ...
                <div class="mb-2">
                    <form>
                        ...
                        Sort by:
                            <select v-model="selectedSort" @change="sortRecipe">
                        ...
                        <!-- <button type="button" class="btn btn-primary animate__animated animate__fadeInUp" @click="sortRecipesByCalories">{{ sortByCaloriesAsc ? 'Sort by Calories (Desc)' : 'Sort by Calories (Asc)' }}</button> -->
